...
class LlamaDecoderLayer(nn.Module):
    def __init__(self, hidden_size: int = 384, num_heads: int = 6, intermediate_size: int = 1536):
        super().__init__()
        self.input_layernorm = RMSNorm(hidden_size)
        self.self_attn = LlamaAttention(hidden_size=hidden_size, num_heads=num_heads)
...
class LlamaBackbone(nn.Module):
    """4-layer Llama transformer backbone accepting inputs_embeds."""
